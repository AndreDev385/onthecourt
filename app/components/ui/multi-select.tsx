        ...
        <div className="inline-block relative w-full">
          <div className="flex flex-col items-center relative">
            <div className="w-full">
              <div
                className="p-1 flex border border-gray-200 bg-white rounded focus:outline-none focus:shadow-outline"
              ...
              >
                <div className="flex flex-auto flex-wrap">
                  {selected.map((value) => (
                    <div
                      key={value.value}
                      className="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-full text-primary-700 bg-gray-200 border border-primary-300"
                    >
                ...
                <div className={`flex-col w-full ${show ? "flex" : "hidden"}`}>
                  {options.map((value) => (
                    <div key={value.value}>
                      <button
                        type="button"
                        className={`cursor-pointer w-full border-gray-100 hover:bg-primary-100 ${
                          value.selected ? "border-primary-700 border-l-2" : ""
                        }`}
                        data-value={value.value}
                        onClick={select}
                      >
